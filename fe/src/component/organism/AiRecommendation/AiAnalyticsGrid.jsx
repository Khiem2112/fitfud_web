...
export default function AiAnalyticsGrid({ dashboardData, profile }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-5">
      {/* Calories Card */}
      <div className="bg-white rounded-2xl shadow-sm border border-border-light p-4 flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <h3 className="text-[9px] font-bold text-text-muted tracking-widest uppercase mb-3">Mục tiêu hằng ngày</h3>
        ...
        <div className="relative w-24 h-24 flex items-center justify-center">
          <svg className="w-full h-full transform -rotate-90" viewBox="0 0 96 96">
            ...
            <circle cx="48" cy="48" r="40" stroke="currentColor" strokeWidth="10" fill="transparent" 
              strokeDasharray={251.2} 
              strokeDashoffset={251.2 - (251.2 * caloriesPercent) / 100} 
              className="text-[#12563F] transition-all duration-1000" />
          </svg>
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
            <span className="text-xl font-extrabold text-[#12563F] leading-none">{dashboardData.target_calories.toLocaleString()}</span>
            <span className="text-[10px] text-text-muted font-bold mt-1 uppercase">Kcal</span>
          </div>
        </div>

        <p className="mt-3 text-[10px] font-bold text-[#12563F]">Trạng thái: Tối ưu</p>
      </div>

      {/* Macro Cards */}
      <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-3">
        {/* Protein */}
        <div className="bg-white rounded-2xl shadow-sm border border-border-light p-4 flex flex-col justify-between border-l-4 border-l-[#12563F]">
          <div>
          ...
          <div className="mt-5">
            <div className="flex justify-between items-end mb-2">
              <span className="text-xl font-extrabold text-[#12563F]">{dashboardData.target_protein}g</span>
        ...
        {/* Carbohydrates */}
        <div className="bg-white rounded-2xl shadow-sm border border-border-light p-4 flex flex-col justify-between border-l-4 border-l-orange-400">
          <div>
          ...
          <div className="mt-5">
            <div className="flex justify-between items-end mb-2">
              <span className="text-xl font-extrabold text-orange-400">200g</span>
        ...
        {/* Chất béo */}
        <div className="bg-white rounded-2xl shadow-sm border border-border-light p-4 flex flex-col justify-between border-l-4 border-l-gray-600">
          <div>
          ...
          <div className="mt-5">
            <div className="flex justify-between items-end mb-2">
              <span className="text-xl font-extrabold text-gray-700">50g</span>
