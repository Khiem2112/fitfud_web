...
export const OrderDetailModal = ({ order: initialOrder, onClose, onReorder }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm modal-overlay-enter" onClick={onClose}>
      <div className="flex items-stretch gap-4 h-[80vh] min-h-[750px] max-h-[900px] w-full max-w-[900px] justify-center">

        {/* Left: Order Detail Panel */}
        <div
          className="w-full max-w-md rounded-3xl bg-bg-card shadow-2xl modal-enter relative overflow-hidden flex flex-col h-full"
          ...
          <div className="p-6 pb-4 flex flex-col flex-1 min-h-0 overflow-hidden">
            ...
            {loading ? (
              ...
              <div className="flex flex-col flex-1 min-h-0">
                ...
                <div className="grid grid-cols-2 gap-y-4 gap-x-6 mb-6 p-4 rounded-xl bg-bg-main border border-border-light shrink-0">
                  <div>
                ...
                {/* Items List */}
                <div className="flex flex-col flex-1 min-h-0">
                  <p className="text-sm font-bold text-text-main mb-3 shrink-0">Danh sách món ăn</p>
                    ...
                    {order.items.map((item, idx) => (
                      <div key={idx} className="flex items-center gap-4 bg-[#F5F5F5] rounded-xl p-3 border border-border-light/50">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="font-bold text-text-main text-sm truncate">{item.dish_name}</p>
                ...
                {/* Totals */}
                <div className="border-t border-dashed border-border-light pt-4 mt-6 shrink-0">
