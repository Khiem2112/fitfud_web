      ...
      <div className="p-[24px] flex flex-col h-full overflow-hidden">
        ...
        <div className="flex items-center gap-2 pb-4 border-b border-border-light shrink-0">
          <button
            ...
            className={`flex h-[22px] w-[22px] shrink-0 items-center justify-center rounded-[4px] border transition-colors ${isAllSelected ? 'border-primary bg-primary' : 'border-border-light bg-white'
              }`}
          >
            {isAllSelected && (
